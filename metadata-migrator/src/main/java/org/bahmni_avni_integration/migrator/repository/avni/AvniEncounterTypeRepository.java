...
public class AvniEncounterTypeRepository {
    private static final String operationalEncounterTypeInsert = "insert into operational_encounter_type (uuid, organisation_id, encounter_type_id, version, audit_id, name) values (uuid_generate_v4(), (select id from organisation), (select id from encounter_type where name = ?), 0, create_audit(), ?)";
