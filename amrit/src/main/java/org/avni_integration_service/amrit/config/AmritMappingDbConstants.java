...
public class AmritMappingDbConstants {
    public static final String MappingType_BeneficiaryRoot = "BeneficiaryRoot";
    public static final String MappingType_BeneficiaryDemographics = "BeneficiaryDemographics";
    public static final String MappingType_BeneficiaryPhoneMaps = "BeneficiaryPhoneMaps";
