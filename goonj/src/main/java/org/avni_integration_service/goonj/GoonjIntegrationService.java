...
public class GoonjIntegrationService {
    ...
    @Autowired
    public GoonjIntegrationService(MappingMetaDataRepository mappingMetaDataRepository, AvniSubjectRepository avniSubjectRepository, DispatchRepositoryGoonj dispatchRepository, DemandRepository demandRepository) {
